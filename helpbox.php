...
Plugin URI: 	http://joshfisher.io/plugins/helpbox.php
		...
		<p>See helpbox settings below.</p>
			...
			<div id="helpboxpreview">
				...
				<?php 
					...
					<div id="sponsorcode" style="width: 100%;max-width: 100%;height: 250px; margin: 10px 0px;">
						<script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
						<!-- Wordpress Plugin Ad 2 -->
						<ins class="adsbygoogle"
						     style="display:block"
						     data-ad-client="ca-pub-4046902643064498"
						     data-ad-slot="6472317011"
				...
				<div class="helpContainer" style="background-color: <?php echo $helpboxcolour; ?>; border: solid <?php echo $helpboxcolour; ?> 1px;">
					<?php 
						...
						// ELSE ECHO NO QUESTIONS
							echo '<ul>';
							echo '<li><h4>You have no questions, add some questions to show them.</h4></li>';
							echo '</ul>';
						}
